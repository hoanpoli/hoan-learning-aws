...
import RubikFont from '@/assets/font/Rubik-VariableFont_wght.ttf';
import { danger, info, neutral, primary, secondary, success, warning } from './colors';
...
const fnBtnColorStyle = (
  color: 'primary' | 'neutral' | 'success' | 'info' | 'warning' | 'danger' | 'secondary',
  ...
  //     overflow: 'hidden',
  //     color: 'white',
  //     backgroundColor: objColor[color][500],
  //     padding: '9px 32px',
  //     zIndex: 1,
  //     transition: 'background-color 0.4s ease-in-out, color 0.4s ease-in-out',
  //     '&:hover': {
  //       backgroundColor: objColor[color][200],
  //       color: objColor[color][700]
  //     }
  //   };
  // }
  if (color === 'neutral') {
    return {
      ...
      ':focus': {
        background: neutral[100],
        boxShadow: `0px 0px 0px 4px ${neutral[25]}`
      },
      ':disabled': {
        background: 'none',
        color: neutral[300]
...
export const components: Components = {
  MuiButton: {
    ...
    styleOverrides: {
      ...
      containedSecondary: fnBtnColorStyle('secondary', 'contained'),
      textSecondary: fnBtnColorStyle('secondary', 'text')
    }
  },
  MuiCircularProgress: {
    defaultProps: {
    ...
    styleOverrides: {
      standard: {
        ...
        ':focus': {
          ...
          boxShadow: `0px 0px 0px 0.8px ${primary[500]}, 0px 0px 0px 4px ${primary[100]}`,
          background: '#fff'
        }
      }
    }
    ...
    styleOverrides: {
      styleOverrides: `
        @font-face {
          ...
          font-display: swap;
          font-weight: 400;
          src: local('Rubik'), local('Rubik'), url(${RubikFont}) format('woff2');
